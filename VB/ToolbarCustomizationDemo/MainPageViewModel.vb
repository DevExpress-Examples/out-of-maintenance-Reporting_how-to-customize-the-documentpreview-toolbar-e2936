...
Namespace ToolbarCustomizationDemo
	Public Class MainPageViewModel
		...
		Public Sub New()
			previewModel_Renamed = New ReportPreviewModel() With {.ServiceUri = "../ReportService.svc", .ReportTypeName = "ToolbarCustomizationDemo.Web.SampleReport"}
			createCommand_Renamed = New DelegateCommand(Of Object)(AddressOf ExecuteCreateCommand, AddressOf CanExecuteCreateCommand)
		End Sub
